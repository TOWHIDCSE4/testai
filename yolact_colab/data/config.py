...
Wood_CLASSES = ("aeroplane", "bicycle", "bird", "boat", "bottle",
                  "bus", "car", "cat", "chair", "cow", "diningtable",
                  "dog", "horse", "motorbike", "person", "pottedplant",
                  "sheep", "sofa", "train", "tvmonitor", "screw")

my_wood_dataset = dataset_base.copy({
    'name': 'Wood Screw',

    'train_images': './data_dataset_coco/',
    'train_info':   './data_dataset_coco/annotations.json',

    'valid_images': './data_valid_coco/',
    'valid_info':   './data_valid_coco/annotations.json',

    'has_gt': True,
    'class_names': Wood_CLASSES
})
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': my_wood_dataset,
    'num_classes': len(my_wood_dataset.class_names) + 1,
